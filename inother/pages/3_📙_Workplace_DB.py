...
st.set_page_config(page_title="Робота з DB", page_icon=":orange_book:")
...
if authentication_status:
    ...
    st.sidebar.header("Робота з DB :orange_book:")

    st.markdown("# Робота з DB :orange_book:")
    st.write(
        """Робота з DB :orange_book:"""
)
