...
st.set_page_config(page_title="Робота з CSV", page_icon=":blue_book:")
...
if authentication_status:
    ...
    st.sidebar.header("Робота з CSV :blue_book:")

    st.markdown("# Робота з CSV :blue_book:")
    st.write(
        """Робота з CSV :blue_book:"""
    )
